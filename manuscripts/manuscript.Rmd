...
sims <- read_csv(file.path(log_dir, "observe_harvest_recruit/sims.csv"), col_types = "inicnn")
sims %>%
...
read_csv(file.path(log_dir, "ram_ex/ram_ex.csv")) %>% 
  filter(model %in% c("biomass", "catch", "POMDP", "Reed", "pgy")) %>%
   mutate(model = fct_recode(model,
                             "Constant escapement" = "Reed",
                             "TAC" = "pgy"
                             )) %>%
