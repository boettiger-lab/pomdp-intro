...
```{r fig.width=3.5,fig.height=3.5, fig.cap=""}
...
```{r message=FALSE, warning=FALSE, fig.width=3.5, fig.height = 7, fig.cap="Comparisons of harvest level that would be recommended by policies considered here relative to historical harvest levels in two commercial fish stocks.  POMDP solution assumes a measurement error of 10%."}
