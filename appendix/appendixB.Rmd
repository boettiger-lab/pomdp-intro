...
Computes model parameter estimates for selected stocks in RAM using NIMBLE. estimate $B_{MSY}$

```{r knitr, include=FALSE}
knitr::opts_chunk$set(comment="", message=FALSE, cache=TRUE, dev="cairo_pdf")
```
...
ram_ex %>%
  filter(model %in% c("biomass", "catch", "POMDP", "Reed", "pgy", "msy")) %>%
