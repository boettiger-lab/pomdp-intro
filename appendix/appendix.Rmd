...
det_simulations <- function(x0 = 1/6, Tmax = 20, 
  ...
  reed_policy  <- function(x) pmax(x - B_MSY,0) ## Optimal when harvest takes place *before* recruitment, assumes we are seeing a pre-harvest size.
  ## consequently, if we use such a policy when we are seeing a the post-harvest size, we give too much buffer.  
...
In the above plots for the MSY
