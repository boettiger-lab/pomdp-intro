...
```{r fig.width=5, fig.height=7, fig.cap=""}
priors <- 
  data_frame(states, 
             prior_low,
             prior_star,
...
```{r  fig.width=5, fig.height=7, fig.cap=""}
prior <- 
  ggplot(priors,aes(state, belief, color = policy)) + 
  geom_line(lwd=1)  + 
  scale_color_manual(values = colors) +
