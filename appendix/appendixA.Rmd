...
source(system.file("examples/pomdp_overestimate.R", package="sarsop")) # portable example code
pomdp_overest_sims <- 
  map2_dfr(models, alphas, function(.x, .y){
